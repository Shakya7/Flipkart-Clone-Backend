...
router.route("/delete-address").patch(authController.protectRouteWithJWT,userController.deleteAddress);
router.route("/update-address").patch(authController.protectRouteWithJWT,userController.updateAddress);
